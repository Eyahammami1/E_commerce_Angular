...
export class ProductListComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    // Appeler listProducts directement pour traiter le cas où il y a des paramètres dans l'URL au moment de l'initialisation du composant.
    this.listProducts();
  ...
  handleListProducts() {
    ...
    //Note:Angular will reuse a component if it is currently beig viewed
  ...
  updatePageSise(pageSize:string){
